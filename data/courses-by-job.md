# NEDS Courses: Who Needs Them and Why

A job- and situation-led guide to all nine courses, covering the real-world reasons someone would come to NEDS for each one. Some of these are things a person needs to *start* a driving career, others are legal obligations to *keep working* in one, and a couple aren't about driving at all.
...
This one isn't really a "job" in itself — it's a legal requirement to keep doing a job that's already been qualified for. Anyone who drives a lorry, bus, or coach professionally (for pay) must complete 35 hours of periodic training every 5 years to keep their Driver CPC valid. Without it, a professional driver can be fined up to £1,000 for driving for a living, regardless of how long they've held their HGV or PCV licence. It applies across the board to Category C1, C, and C+E drivers working professionally.
...
The D4 isn't tied to one job — it's the medical fitness step that sits underneath almost every category above. Anyone applying for their first provisional HGV or PCV licence needs a D4 alongside their D2 application, and anyone who already holds one of these licences needs to keep renewing it — every 5 years between ages 45 and 65, then annually from 65 onward. In effect, it's a recurring requirement for the entire working life of anyone in a C1, C, C+E, or PCV driving career, not a one-off step at the start.
...
Someone starting an HGV driving career from scratch is likely to need, in rough order: a D4 medical, then C1 or Category C, then Driver CPC to keep working professionally, and possibly C+E later for higher-paying Class 1 work. Someone in a trade, agriculture, or equestrian context is more likely to need just B+E. Someone moving into hazardous-goods transport needs ADR on top of their existing HGV licence. Forklift training and OLAT sit apart from the driving-licence path entirely — one for warehouse/site-based roles, the other for people managing compliance rather than driving.

Sources:
- [Which HGV Licence Do You Need? (Heads of the Valleys Training)](https://hovtraining.com/which-hgv-licence-do-i-need-for-my-career/)
- [B+E Trailer Licence UK: 2026 Rules (PassRates)](https://passrates.uk/guide/b-plus-e-trailer-licence)
- [Become a qualified dangerous goods (ADR) vehicle driver (GOV.UK)](https://www.gov.uk/become-dangerous-goods-driver)
- [OLAT Training: Who Needs It & When? (Steve Rounds Training)](https://steverounds.co.uk/do-i-need-olat-training-a-guide-for-operators-directors-transport-managers/)
- [Driver CPC training for qualified drivers (GOV.UK)](https://www.gov.uk/driver-cpc-training)
